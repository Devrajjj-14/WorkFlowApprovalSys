...
// Without this: ClaimTypes is unknown — not used here but imported for consistency with other controllers
...
public class AuthController : ControllerBase
{
    ...
    // Constructor — DI injects IAuthService (registered as AuthService in Program.cs)
    // Without this constructor: DI can't create AuthController — both auth endpoints return 500 on startup
