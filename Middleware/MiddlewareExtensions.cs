...
public static class MiddlewareExtensions
{
    ...
    public static IApplicationBuilder UseCustomMiddleware(this IApplicationBuilder app)
    {
        ...
        // Checks every authenticated request against the token blacklist — blocks revoked tokens
        // Without this line: logged-out tokens remain usable until they naturally expire
